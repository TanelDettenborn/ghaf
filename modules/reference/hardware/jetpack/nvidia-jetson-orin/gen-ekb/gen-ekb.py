...
def main():
    ...
    parser.add_argument('-in_my_secret', nargs=1, required=False, help="My secret")
    ...
    if args.in_my_secret != None and os.path.exists(args.in_my_secret[0]):
        in_content += pack_bin(args.in_my_secret[0], ekb_my_secret)

...
buildLinux (rec {
  ...
  src = applyPatches {
    src = fetchgit {
      ...
      hash = "sha256-8tssyTpNuba0R4sgywgiIqhMlA78/trQStEQNumqQ2M=";
      rev = "1e89a1be4fe907d9c573fe98875bff132e7ac6c8";
    };
  ...
  up66kern = pkgs.linuxPackagesFor  (pkgs.callPackage up66-pkg{});
in
{
  ...
  config = mkIf cfg.enable {
    ...
    boot = {
      ...
      kernelPackages = lib.mkForce (up66kern.extend pkgs.nvidia-jetpack.kernelPackagesOverlay);

...
(
  ...
  in
  {
    hardware.nvidia-jetpack.firmware.optee.pkcs11Support = config.ghaf.hardware.nvidia.orin.optee.pkcs11.enable;
    ...
    hardware.nvidia-jetpack.firmware.optee.patches = lib.optional config.ghaf.hardware.nvidia.orin.optee.pkcs11.lockPinAfterFailedLoginAttempts
